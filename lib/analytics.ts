...
/**
 * Full analytics payload for a time range ('7d' | '30d' | '90d'). Used by the
 * /api/analytics route (dashboard charts) and by the manager agent's
 * get_analytics tool (for business insights).
 */
